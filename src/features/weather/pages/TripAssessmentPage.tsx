  ...
  if (!trip) {
    return (
      <div className="p-4">
        ...
        <Link to="/trips" className="mt-4 inline-block text-sea-400">Back</Link>
      </div>
    );
  }
        ...
        <section className="rounded-lg border border-slate-800 bg-slate-900 p-4">
          ...
          {!apiKeys.windy && (
            <p className="mt-3 rounded bg-amber-500/10 px-3 py-2 text-xs text-amber-400">
              ...
              <Link to="/boat" className="underline">Add it in Boat Config</Link>.
            </p>
          )}
          {error && (
                            ...
                            {seg.items.slice(0, 8).map((bp) => {
                              ...
                              return (
                                <Link
                                  ...
                                  to={`/destinations/${bp.destination.id}`}
